...
<body>
    ...
    <div class="container">
            ...
            <div class="panel-body">
                <form method="get" action="stagiaires.php" class="form-inline">
                    ...
                    <select name="idfiliere" class="form-control" id="idfiliere" onchange="this.form.submit()">
                        ...
                        <?php foreach($resultatFiliere->fetchAll(PDO::FETCH_ASSOC) as $filiere) { ?>
                            <option value="<?php echo $filiere['idFiliere']; ?>" <?php echo ($filiere['idFiliere'] == $idfiliere) ? 'selected' : ''; ?>>
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">Liste des Stagiaires (
                <?php echo $nbrStagiaire ?> Stagiaires)
            </div>
            <div class="panel-body">
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <?php while($stagiaire = $resultatStagiaire->fetch()) { ?>
                            <tr>
                                <td>
                                    <?php echo $stagiaire['idStagiaire'] ?>
                                </td>
                                <td>
                                    <?php echo $stagiaire['nom'] ?>
                                </td>
                                <td>
                                    <?php echo $stagiaire['prenom'] ?>
                                </td>
                                <td>
                                    <?php echo $stagiaire['nomFiliere'] ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-info btn-edit-delete" href="../fpdf/page_document.php?id_stagiaire=<?php echo $stagiaire['idStagiaire']; ?>">
