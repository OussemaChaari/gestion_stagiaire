...
<body>
    ...
    <div class="container">
            ...
            <div class="panel-body">
                <form method="get" action="filieres.php" class="form-inline">
                    <div class="form-group">
                        <input type="text" name="nomF" placeholder="Nom de la filière" class="form-control" value="<?= $nomf; ?>"/>
                    </div> 
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">Liste des filieres (<?= $nbrFiliere; ?>)</div>
            <div class="panel-body">
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <?php while($filiere = $resultatF->fetch()) { ?>
                            <tr>
                                <td>
                                    <?php echo $filiere['idFiliere'] ?>
                                </td>
                                <td>
                                    <?php echo $filiere['nomFiliere'] ?>
                                </td>
                                <td>
                                    <?php echo $filiere['niveau'] ?>
                                </td>
                                <?php if ($_SESSION['user']['role']== 'ADMIN') {?>
